...
public class MainViewModel extends AndroidViewModel {
    private  static MovieDatabase database;//sozdayom object bd
    private LiveData<List<Movie>> movies;  // spisok filmov
    private LiveData<List<FavouriteMovie>> favouriteMovies;  // spisok filmov
